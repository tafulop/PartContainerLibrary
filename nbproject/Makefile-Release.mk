...
${OBJECTDIR}/ArmPartContainer.o: ArmPartContainer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArmPartContainer.o ArmPartContainer.cpp
...
${OBJECTDIR}/ArmPartContainer_nomain.o: ${OBJECTDIR}/ArmPartContainer.o ArmPartContainer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArmPartContainer_nomain.o ArmPartContainer.cpp;\
	else  \
